        ...
        >
          ...
          >
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <div className="text-[20px] sm:text-[24px] md:text-[28px] font-bold text-white tracking-tight">$4B+</div>
              <div className="text-[10px] sm:text-[12px] font-medium text-[#A0A0A0] mt-1">Volume Processed</div>
            </div>

            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <div className="text-[20px] sm:text-[24px] md:text-[28px] font-bold text-white tracking-tight">99.99%</div>
              <div className="text-[10px] sm:text-[12px] font-medium text-[#A0A0A0] mt-1">System Uptime</div>
            </div>

            <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
              <div className="text-[20px] sm:text-[24px] md:text-[28px] font-bold text-white tracking-tight">256-bit</div>
              <div className="text-[10px] sm:text-[12px] font-medium text-[#A0A0A0] mt-1">AES Encryption</div>
            </div>
          </motion.div>
          ...
          <motion.div variants={item}>
            <button
              ...
              className="group relative flex items-center justify-center gap-2 rounded-full border border-transparent bg-[#FF835D] px-8 py-3.5 text-[15px] font-semibold text-white transition-all duration-300 shadow-none hover:brightness-110 hover:-translate-y-1 active:scale-95 active:translate-y-0"
            >
